...
def filter_instruments(instruments):
    ...
    for data in instruments:
        if((data["instrument_type"] == "EQ" or data["instrument_type"] == "BE")):
        # if((data["instrument_type"] == "EQ" or data["instrument_type"] == "BE") and data["tradingsymbol"] in TICKERS):  
            final_frame.append({
...
instruments = zerodha.instruments()
...
if __name__ == '__main__':
    ...
    stock_set = set()
    try:
        # requests.post(url=url, json={'data':json.dumps(EMA_FOR_DAYS)}) 
